...
public class ProjectSecurityProdConfig {
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService,
        ...
        InfluencerProdUsernamePwdAuthenticationProvider authenticationProvider =
                new InfluencerProdUsernamePwdAuthenticationProvider(userDetailsService, passwordEncoder);
